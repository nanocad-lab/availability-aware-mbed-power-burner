...
GCC_BIN =
PROJECT = availability-aware-mbed-power-burner
OBJECTS = ./main.o 
...
INCLUDE_PATHS = -I. -I./mbed -I./mbed/TARGET_KL46Z -I./mbed/TARGET_KL46Z/TOOLCHAIN_GCC_ARM -I./UtilityLib -I./SensorsLib 
...
CC_SYMBOLS = -DTARGET_KL46Z -DTARGET_M0P -DTARGET_Freescale -DTARGET_KLXX -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_GCC -D__CORTEX_M0PLUS -DARM_MATH_CM0PLUS -DMBED_BUILD_TIMESTAMP=1396905171.48 -D__MBED__=1 
